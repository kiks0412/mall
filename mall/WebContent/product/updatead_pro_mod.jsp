...
<body>
	...
	<div class="w3-content" style="max-width: 1500px">
		...
		%>
		<section>
			<h3 align="center" style="background-color:#f5c2f8;font-size:25px;width:60%;margin:auto;">상품 수정</h3>
			...
			<input type ="hidden" name = "p_no" value="<%=p_no%>"/>
				<table border align="center" width=60%>
					<tr>
						...
						<td><input type="text" name="p_no" id="p_no" value="<%=p_no%>" readonly="readonly"></td>
					</tr>
					<tr>
						<td class="label">상품 이름</td>
						<td><input type="text" name="p_name" id="p_name" value="<%=p_name%>"></td>
					</tr>
					<tr>
						<td class="label">상품 태그</td>
						<td><input type="text" name="p_tag" id="p_tag" value="<%=p_tag%>"></td>
					</tr>
					<tr>
						<td class="label">상품 색상</td>
						<td><input type="text" name="p_color" id="p_color" value="<%=p_color%>"></td>
					</tr>

					<tr>
						<td class="label">사이즈</td>
						<td><input type="text" name="p_size" id="p_size" value="<%=p_size%>">
					</tr>
					<tr>
						<td class="label">이미지</td>
						<td><input type="text" name="p_img" id="p_img" value="<%=p_img%>"></td>
					</tr>
					<tr>
						<td class="label">가격</td>
						<td><input type="text" name="p_price" id="p_price" value="<%=p_price%>"></td>
					</tr>
					<tr>
						<td class="label">정보</td>
						<td><input type="text" name="p_info" id="p_info" value="<%=p_info%>"></td>
					</tr>
					<tr>
						<td class="label">상태</td>
						<td><select name="p_condition" id="p_conditio" value="<%=p_condition%>">
